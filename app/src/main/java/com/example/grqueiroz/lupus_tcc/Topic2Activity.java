        ...
        mNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener(){
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem){
                ...
                switch (menuItem.getItemId()){
                    case(R.id.o_que_e):
                        intent.setClass(Topic2Activity.this, Topic1Activity.class);
                        startActivity(intent);
                        break;
                    case(R.id.o_que_causa):
                        break;
                    case(R.id.como_e_diagnosticado):
                        intent.setClass(Topic2Activity.this, Topic3Activity.class);
                        startActivity(intent);
                        break;
                    case(R.id.como_afeta_corpo):
                        intent.setClass(Topic2Activity.this, Topic4Activity.class);
                        startActivity(intent);
                        break;
                    case(R.id.como_vou_melhorar):
                        intent.setClass(Topic2Activity.this, Topic5Activity.class);
                        startActivity(intent);
                        break;
                    case(R.id.como_sera_dia_a_dia):
                        intent.setClass(Topic2Activity.this, Topic6Activity.class);
                        startActivity(intent);
                        break;
                }
